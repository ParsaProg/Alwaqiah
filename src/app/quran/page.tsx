...
export default function QuranPage() {
  return (
    <div className="mt-[50px] w-[90%] flex flex-col items-center justify-center mx-auto">
      <div className="w-full flex items-center justify-between mx-auto bg-[#dedbdb] rounded-xl p-5 text-black">
        ...
        <section className="flex items-center gap-x-2">
          <h3>سوره:</h3>
          <div className="gap-x-5 overflow-hidden text-start bg-white rounded-lg p-1 w-[200px] border-[0.5px] border-[#0638fe34] text-sm text-black flex justify-start items-center">
            <input
              defaultValue={"1.حمد"}
        ...
        <section className="flex items-center gap-x-2">
          <h3>آیه:</h3>
          <div className="overflow-hidden text-center bg-white rounded-lg p-2 w-[150px] border-[0.5px] border-[#0638fe34] text-sm text-black flex justify-start items-start">
            <input
              defaultValue={"1"}
